      ...
      <div class="grid grid-cols-12 gap-4">
        ...
        <div class="col-span-12 px-4 md:col-span-3 text-center md:text-left my-4">
          <ul class="text-gray-500 dark:text-gray-400 font-medium">
            <li class="mb-4">
              <NuxtLink to="/news" class="text-white hover:underline">Новости</NuxtLink>
            </li>
            <li class="mb-4">
              <NuxtLink to="/about-us" class="text-white hover:underline">О Нас</NuxtLink>
            </li>
            <li class="mb-4">
              <NuxtLink to="/teams" class="text-white hover:underline">Наша команда</NuxtLink>
            </li>
            <li class="mb-4">
...
<!--          </button>-->
          <a
            href="https://t.me/energyexperts"
            data-te-ripple-init
            data-te-ripple-color="light"
            class="mb-2 inline-block rounded-full p-3 text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg"
            style="background-color: #092A44">
            <img src="~/assets/images/telegram.png" class="w-4 h-4">
            <!--            <svg-->
<!--              xmlns="http://www.w3.org/2000/svg"-->
<!--              class="h-4 w-4"-->
<!--              fill="currentColor"-->
