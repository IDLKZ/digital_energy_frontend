<template>
  <section class="bg-[#0C3759]">
    <div class="container mx-auto py-[20px] md:py-[50px] px-4">
      <div class="grid grid-cols-12 gap-4">
        ...
        <div class="col-span-12 px-4 md:col-span-3 text-center md:text-left my-4">
          <ul class="text-gray-500 dark:text-gray-400 font-medium">
            <li class="mb-4">
              <a href="#" class="text-white hover:underline">Новости</a>
            </li>
            <li class="mb-4">
              <a href="#" class="text-white hover:underline">О Нас</a>
            </li>
            <li class="mb-4">
              <a href="#" class="text-white hover:underline">Наша команда</a>
            </li>
            <li class="mb-4">
              <a href="#" class="text-white hover:underline">Проекты</a>
            </li>
            <li class="mb-4">
              <a href="#" class="text-white hover:underline">Инициативы</a>
            </li>
            <li class="mb-4">
              <a href="#" class="text-white hover:underline">Эксперты</a>
            </li>
          </ul>
        ...
        <div class="col-span-12 px-4 md:col-span-3 text-center md:text-left my-4">
          <ul class="text-gray-500 dark:text-gray-400 font-medium">
            ...
            <li class="mb-4">
              <a href="#" class="text-white text-md hover:underline font-light">Мангилик Ел, 55/13,</a><br>
              <a href="#" class="text-white text-md hover:underline font-light">Блок С 2.1</a>
            </li>
            <li class="mb-4">
              <a href="tel:+7 717 277-98-01" class="text-white text-md hover:underline font-light">+7 717 277-98-01</a><br>
              <a href="tel:+7 717 277-98-04" class="text-white text-md hover:underline font-light">+7 717 277-98-04</a>
            </li>
            <li class="mb-4">
              <a href="mailto:info@energy.org.kz" class="text-white hover:underline">info@energy.org.kz</a>
            </li>
          </ul>
      ...
      <div class="grid grid-cols-12 gap-4">
        <div class="col-span-12 text-center md:text-left">
          <p class="text-white text-sm">
            © 2023 • Digital Energy • Все права сохранены
          </p>
        </div>
